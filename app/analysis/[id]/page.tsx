...
export default async function AnalysisPage({
  ...
  const STATUTE_LINKS: Record<string, { label: string; url: string }> = {
    ...
    TN: { label: "Official Tennessee General Assembly", url: "https://www.tnlegislature.gov/" },
    ...
    MS: { label: "Official Mississippi Legislature",       url: "https://legislature.ms.gov/" },
    ...
    WY: { label: "Official Wyoming Statutes & Constitution", url: "https://www.wyoleg.gov/stateStatutes/StateStatutes" },
