  ...
  try {
    ...
    const saved = await prisma.analysis.create({
      data: {
        ...
        template: "compliance_checker",
        product: "error" in deterministicResult ? null : deterministicResult.product,
        label: "error" in deterministicResult ? null : deterministicResult.label,
        description: "error" in deterministicResult ? null : deterministicResult.description,
        documentType: "error" in deterministicResult ? null : deterministicResult.documentType,
